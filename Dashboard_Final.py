...
with st.form("entry_form"):
    ...
    if companyName is not None:
        ...
        with col3:
            ...
            """
            headlines = pd.read_csv("~/Downloads/FinalHeadlines.csv")
            labels = pd.read_csv("~/Downloads/labels.csv")
            ytest = pd.read_csv("~/Downloads/ytest.csv")
            ...
            #st.write("** ")
        with st.button("Recommendations"):
            ...
            if Decision == 0:
                ...
                with col2:
                    results = f" Market is going down therefore recommendation is to **SELL** the stocks as the Market Situation Warrants"
                    st.markdown(results)
            else:
                with col1:
                    recomdColor = "#436436" 
